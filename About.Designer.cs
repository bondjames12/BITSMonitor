namespace BitsMonitor
{
    partial class About
    {
        ...
        private void InitializeComponent()
        {
			...
			this.labelProductName.Text = "BitsMonitor - simple interface for BITS";
			...
			this.labelCopyright.Text = "Freeware.";
			...
			this.labelCompanyName.Text = "Company Name: whole world / milky way";
